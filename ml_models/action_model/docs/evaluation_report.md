...
Model: `models/greennode_action.onnx` · tolerance for durations: ±5 min

## 1. Scenario table (best / average / worst cases)

**30/33 scenarios passed (90.9%)**
...
| T-04 | Air temperature | Worst | fan HIGH 20m, vent FULL, mister 10m | fan HIGH 25m, vent FULL, mister 10m | PASS |
...
| H-02 | Relative humidity | Average | fan LOW 15m, vent HALF,  | fan LOW 20m, vent HALF,  | PASS |
...
| C-05 | CO2 | Average | fan OFF 0m, vent CLOSED,  | fan OFF 0m, vent CLOSED, lights 10m | FAIL |
...
| L-02 | Light (DLI) | Average | fan OFF 0m, vent CLOSED, lights 180m | fan OFF 0m, vent CLOSED, lights 240m | FAIL |
...
| X-03 | Combined | Worst | fan MEDIUM 20m, vent HALF, heater 20m | fan MEDIUM 25m, vent HALF, heater 25m | PASS |

## 2. Unseen random data (10,000 rows)

**Full-action match: 90.3%** (every actuator and every duration correct)
...
| lights on/off | 99.9% |
| co2_inject on/off | 99.9% |
| fan_min within ±5 min (when ON) | 93.0% |
| mister_min within ±5 min (when ON) | 99.0% |
| heater_min within ±5 min (when ON) | 91.7% |
| irrigation_min within ±5 min (when ON) | 97.5% |
| lights_min within ±5 min (when ON) | 72.9% |
| co2_min within ±5 min (when ON) | 100.0% |
