// ============================================================
// CropFit — Zero-dependency SVG Icons
// Hand-crafted, responsive icons with standard SVG props
// ============================================================
...
export function SproutIcon({ size = 24, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function WifiOffIcon({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
